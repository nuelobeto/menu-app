...
export const AppLayout = ({ goBack, children, title }: Props) => {
	return (
		<div className="w-full max-w-[448px] bg-white mx-auto relative">
			<div className="fixed top-0 left-[50%] translate-x-[-50%] w-full max-w-[448px] h-screen pointer-events-none bg-[url('/images/bg-vector.png')] bg-no-repeat bg-right-bottom bg-[length:100%_40%]"></div>
